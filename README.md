...
The frontend starter also provides an example of interactions with your AlgorandappClient in [`AppCalls.tsx`](projects/algorand-frontend/src/components/AppCalls.tsx) component by default.
